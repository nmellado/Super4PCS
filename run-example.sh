...
time -p ./super4pcs -i hippo1.obj hippo2.obj -o 0.8 -d 0.01 -t 1000 -n 300 -r super4pcs.obj
time -p ./super4pcs -i hippo1.obj hippo2.obj -o 0.8 -d 0.01 -t 1000 -n 300 -r 4pcs.obj -x
